...
LITECOIND=${LITECOIND:-$SRCDIR/sportcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/sportcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/sportcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/sportcoin-qt}
