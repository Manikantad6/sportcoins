...
const char * const BITCOIN_CONF_FILENAME = "sportcoin.conf";
const char * const BITCOIN_PID_FILENAME = "sportcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Sportcoin";
#else
    // Unix
