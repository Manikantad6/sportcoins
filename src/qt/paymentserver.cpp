...
const char* BIP71_MIMETYPE_PAYMENT = "application/sportcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/sportcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/sportcoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start sportcoin: click-to-pay handler"));
        }
        else {
