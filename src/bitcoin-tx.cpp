...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sportcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sportcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sportcoin transaction") + "\n" +
              "  sportcoin-tx [options] -create [commands]   " + _("Create hex-encoded sportcoin transaction") + "\n" +
              "\n";
