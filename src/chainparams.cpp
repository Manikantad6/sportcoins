...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.sportcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.sportcointools.com");
        vSeeds.emplace_back("dnsseed.sportcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.sportcointools.com");
        vSeeds.emplace_back("seed-b.sportcoin.loshan.co.uk");
